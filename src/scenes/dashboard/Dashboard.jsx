  ...
  return (
    <Box m={5}>
      <Box display="flex" justifyContent="space-between" alignItems="center">
        <Header title="داشبورد" subtitle="به داشبورد خود خوش آمدید" />
      ...
      >
        ...
        >
          ...
          >
            ...
            <Typography>شامل مخارج و هزینه های و اضافی</Typography>
          </Box>
        </Box>
        ...
        >
          <Typography variant="h5" fontWeight="600" textAlign="center">
            میزان فروش براساس منطقه جغرافیایی
          </Typography>
          <Box height="200px">
